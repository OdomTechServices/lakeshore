...
<footer>
        ...
        <div class="row">
            <div class="col-md-4">
                <ul class="list-unstyled text-left">
                    ...
                    <li><a href="<?=root?>cabins"><h4>Cabins</h4></a></li>
                    <li><a href="<?=root?>motels"><h4>Motels</h4></a></li>
                    <li><a href="<?=root?>rv-parks"><h4>RV Parks</h4></a></li>
            ...
            <div class="col-md-4">
                <ul class="list-unstyled text-left">
                    <li><a href="<?=root?>faqs"><h4>FAQ's</h4></a></li>
    ...
    <div class="container"
        <div class="row">
            <div class="col-xs-12 ">
              <p class="" style="color:white">Copyright &copy; <?php echo date("Y"); ?> <a href="/">Lakeshore Lodge & RV</a> | Designed By: <a href="">Odom Tech Services</a> </p>
            </div>
        </div>
    </div>
</footer>
